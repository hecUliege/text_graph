...
class Text():
    ...
    def __init__(self, text: str, subj_list, action, dobj, pobj_list, date):
        """
        ...
        self.passive = False
        self.subj = None # Addresser
        self.subj_list = subj_list
        self.pobj = None # Addressee
        self.dobj = dobj # action result
        self.date = date
        self.date_annotated = None
        self.pobj_list = pobj_list
        self.hasnext = None
        self.action = action # Action
        self.post_processing_llm()
    ...
    def verb(self):
        ...
        if self.verb_idx is None:
            return ''
        return self.tree[self.verb_idx].text
